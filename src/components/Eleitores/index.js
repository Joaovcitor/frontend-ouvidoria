                    ...
                    {grupo.eleitores
                      ...
                      .map((eleitor) => {
                        const qtyDemandas = demandas.filter(
                          (demanda) => eleitor.id === demanda.eleitorId
                        );
                        return (
                          <nav key={eleitor.id}>
                            ...
                            <Links to={`/eleitor/editar/${eleitor.id}`}>
                              Editar
                            </Links>
                            <Links to={`/eleitor/demandas/${eleitor.id}`}>
                              Ver Demandas
                            </Links>
                            <Links
                              to={`/eleitor/agendas-eleitor/${eleitor.id}`}
                            >
                              Ver Agendas
                            </Links>
                          </nav>
